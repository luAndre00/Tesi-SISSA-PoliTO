...
if __name__ == "__main__":
    ...
    path_load = "/scratch/atataran/Tesi-SISSA-PoliTO/Codici/Parametric_elliptic/check/Checkpoint/PIARCH/"
    ...
    pinn = PINN.load_from_checkpoint(checkpoint_path=checkpoint_completo + "_piarch.ckpt", problem=opc, model=model, extra_features=feat)
