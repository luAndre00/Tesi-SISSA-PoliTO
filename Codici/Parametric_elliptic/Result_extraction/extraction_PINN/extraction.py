...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkp", help="directory of the checkpoint to be used", type=str, 
                        default="/scratch/atataran/Tesi-SISSA-PoliTO/Codici/Parametric_elliptic/pinn.ckpt")
    ...
    parser.add_argument("--fem", help="whether or not to plot the fem solutoins", type=int, default=0)
    ...
    model = FeedForward(5, 3, layers = [40,40,20], func = Softplus)
