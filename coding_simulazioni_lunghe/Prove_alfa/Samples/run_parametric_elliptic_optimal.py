...
if __name__ == "__main__":
    ...
    opc.discretise_domain(n=1800, mode='random', variables=['x1', 'x2'], locations=['D'])
    opc.discretise_domain(n=100, mode='random', variables=['mu'], locations=['D'])
    opc.discretise_domain(n=400, mode='random', variables=['x1', 'x2'], locations=['gamma1', 'gamma2', 'gamma3', 'gamma4'])
    opc.discretise_domain(n=100, mode='random', variables=['mu'], locations=['gamma1', 'gamma2', 'gamma3', 'gamma4'])
    ...
    plt.gcf().savefig('samples.pdf', format='pdf')
